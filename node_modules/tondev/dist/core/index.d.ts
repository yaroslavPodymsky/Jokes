...
export declare function matchName(x: NameAlias, test: string | undefined | null): boolean;
export declare function nameInfo(x: NameAlias, namePrefix?: string, aliasPrefix?: string): string;
/**
...
export declare function tondevInit(): void;
export declare function tondevDone(): void;
/**
 * Home directory where tool must store all tool related resources.
 */
export declare function tondevHome(): string;
export declare function getArgVariants(arg: CommandArg): Promise<CommandArgVariant[] | undefined>;
